...
def contact_page():
    ...
    ### Direct Contact
    - **Email**: [timing_leung@outlook.com](mailto:timing_leung@outlook.com)
    - **Phone**: +86 13537552343
    ...
    st.markdown("""
    ### Office Hours
    I'm generally available for virtual meetings Monday through Friday, 2 PM to 5 PM Eastern Time.
